...
namespace GSC.Rover.DMS.BusinessLogic.Contact
{
    public class ContactHandler
    {
        ...
        public Entity GenerateEmployeeCredentials(Entity contactEntity)
        {
            ...
            if (!contactEntity.Contains("gsc_recordtype")) 
            {
            	return null; 
            }

            if (!contactEntity.FormattedValues["gsc_recordtype"].Equals("Employee"))
            { 
            	return null; 
            }
        ...
        {
            if (!contactPerson.Contains("gsc_recordtype")) 
            {
            	return; 
            }
            if (!contactPerson.FormattedValues["gsc_recordtype"].Equals("Contact Person")) 
            { 
            	return; 
            }
